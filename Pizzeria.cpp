...
// Pizzeria.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CPizzeriaApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CPizzeriaApp

CPizzeriaApp::CPizzeriaApp()
{
...
// Único objeto CPizzeriaApp

CPizzeriaApp theApp;


// Inicialización de CPizzeriaApp

BOOL CPizzeriaApp::InitInstance()
{
